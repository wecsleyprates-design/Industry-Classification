...
FEATURE_NAMES = [
    # ── v2: Binary agreement signals (replaces raw label-encoded codes) ───
    # See feature_engineering.py for full documentation.
    # ── A. Vendor confidence scores ──────────────────────────────────────────
    "zi_match_confidence", "efx_match_confidence", "oc_match_confidence",
    "zi_naics_confidence",
    "zi_weighted_conf", "efx_weighted_conf", "oc_weighted_conf",
    "max_vendor_conf", "sum_vendor_conf",
    # ── B. Binary sector agreement ───────────────────────────────────────────
    "zi_efx_sector_agree", "zi_oc_sector_agree", "efx_oc_sector_agree",
    "all_3_sector_agree", "sector_agreement_count",
    "zi_efx_group_agree",
    "zi_efx_code_agree", "zi_oc_code_agree",
    # ── C. Dominant sector vote ───────────────────────────────────────────────
    "dominant_sector_weighted_conf",
    # ── D. Source availability ────────────────────────────────────────────────
    "has_zi_match", "has_efx_match", "has_oc_match", "n_sources",
    "has_zi_naics", "has_efx_naics", "has_oc_naics", "n_vendor_naics",
    # ── E. Name signals ───────────────────────────────────────────────────────
    "name_token_hash_1", "name_token_hash_2", "name_token_hash_3",
    "name_len_words",
    "name_kw_food", "name_kw_personal", "name_kw_health",
    "name_kw_professional", "name_kw_construction", "name_kw_transport",
    "name_kw_retail", "name_kw_finance", "name_kw_realestate",
    "name_kw_education", "name_kw_arts",
    "name_has_any_keyword", "name_kw_agrees_zi",
    # ── F. Firmographic ───────────────────────────────────────────────────────
    "efx_employee_log", "efx_revenue_log",
    "zi_employee_log",  "zi_revenue_log",
    # ── G. Geographic ─────────────────────────────────────────────────────────
    "state_encoded", "country_encoded", "is_us_business",
    # ── H. AI metadata ────────────────────────────────────────────────────────
    "ai_confidence_high", "ai_confidence_med", "ai_confidence_low",
    "ai_naics_is_fallback", "ai_has_website",
    # ── I. ZI top-3 uncertainty ───────────────────────────────────────────────
    "zi_top3_sector_spread", "efx_in_zi_top3",
    # ── J. EFX secondary agreement ────────────────────────────────────────────
    "efx_secondary_agrees_zi",
    # ── K. SIC cross-source ───────────────────────────────────────────────────
    "sic_zi_efx_agree",
    # ── Pipeline B ────────────────────────────────────────────────────────────
    "pipeline_b_conf",
