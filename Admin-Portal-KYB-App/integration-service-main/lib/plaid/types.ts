...
export namespace IPlaidIDV {
	...
	export interface DocumentaryVerificationDocument {
		...
		analysis?: {
			...
			aamva_verification?: { is_verified?: boolean };
		};
		images?: {
	...
	/** Per-document integrity result exposed on the KYC owners API */
	export interface DocumentIntegrityResult {
		attempt: number;
		plaid_document_status: string;
		document_integrity_status: "clear" | "suspected" | "failed";
		details: {
			authenticity: string | null;
			image_quality: string | null;
			aamva_is_verified: boolean | null;
		};
	}

	export type DocumentIntegrityResults = DocumentIntegrityResult[];
