...
export interface AdverseMediaArticleRow {
	id: string;
	title: string;
	link: string;
	date: string | null;
...
export interface AdverseMediaSection {
	title: string;
	risk_level: "HIGH" | "MEDIUM" | "LOW";
	relevant_articles: AdverseMediaArticleRow[];
	total_articles: number;
}

export type AdverseMediaReport = (AdverseMediaResponse & {
	sections?: AdverseMediaSection[];
	total_articles?: number;
	total_displayed_articles?: number;
	case_id?: string;
}) | Record<string, never>;
