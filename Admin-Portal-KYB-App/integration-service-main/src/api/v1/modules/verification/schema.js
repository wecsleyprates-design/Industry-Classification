...
import { baselayerWebhookBodySchema } from "#lib/baselayer";
import {
	businessEntityVerificationParamsSchema,
	internalBusinessEntityVerificationSchema,
	updateBusinessEntityPayloadSchema,
	webhookEventSchema
} from "#lib/middesk";
...
export const schema = {
	...
	handleBaselayerWebhook: z.object({
		body: baselayerWebhookBodySchema
	}),
