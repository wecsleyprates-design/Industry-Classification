import { errorOnInvalidBaselayerSignature } from "#lib/baselayer";
...
router
	.route("/verification/businesses/2/webhook")
	.post(
		errorOnInvalidBaselayerSignature,
		validateTypedSchema(schema.handleBaselayerWebhook),
		api.handleBaselayerWebhook
	)
	.all(methodNotAllowed);
...
router
	...
	.post(
		errorOnInvalidTruliooSignature,
		validateTypedSchema(schema.handleInternationalBusinessWebhook),
		internationalBusinessController.handleInternationalBusinessWebhook
	)
	.all(methodNotAllowed);
...
router
	...
	.post(
		errorOnInvalidTruliooSignature,
		validateTypedSchema(schema.handleInternationalBusinessWebhook),
		internationalBusinessController.handleInternationalBusinessPersonWebhook
	)
	.all(methodNotAllowed);
