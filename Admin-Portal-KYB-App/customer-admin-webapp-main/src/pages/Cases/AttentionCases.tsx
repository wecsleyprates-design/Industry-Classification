...
const AttentionCases = () => {
	...
	const FilterData: TFilterOption[] = [
		...
		},
		{
			...
			filterOptions: [
				{ label: "Under manual review", value: "4", disabled: true },
				{ label: "Risk alert", value: "14", disabled: true },
				{ label: "Paused", value: "18", disabled: true },
			],
		},
		{
			title: "Date & time",
	...
	useEffect(() => {
		setSearchParams(
			(prev) => {
				if (savedPayload?.attention) return savedPayload?.attention;
				prev.set("page", "1");
