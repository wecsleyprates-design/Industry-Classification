...
export interface GetBankingIntegrationResponseData {
	...
	match: boolean;
	depositAccountInfo: GetBankingIntegrationResponseDataDepositAccountInfo | null;
	verification_result: BankAccountVerificationEgg | null;
	routing?: string | null;
...
export interface BankAccountVerificationEgg {
	id?: string;
	bank_account_id?: string;
	case_id?: string;
