...
const Badge: React.FC<BadgeProps> = ({
	...
	const getClasses = (color?: "red" | "yellow" | "green" | "blue") => {
		let classes = ``;
		switch (color) {
			case "red":
				classes = classes + "bg-[#FEE2E2] text-[#B91C1C] font-medium";
				break;
			case "yellow":
				classes = classes + "bg-[#FEF9C3] text-[#A16207] font-medium";
				break;
			case "green":
				classes = classes + "bg-[#DCFCE7] text-[#15803D] font-medium";
				break;
			case "blue":
				classes = classes + "bg-blue-100 text-blue-700 font-medium";
				break;
			default:
				classes = classes + "bg-[#DCFCE7] text-[#15803D] font-medium";
		}
	...
	return (
		<>
			<span
				className={twMerge(defaultClasses, getClasses(color), className)}
				{...props}
			>
				{icon && icon} {text}
				{isRemoveable ? (
