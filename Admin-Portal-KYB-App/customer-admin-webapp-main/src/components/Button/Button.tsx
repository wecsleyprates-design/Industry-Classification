...
const style = {
	...
	default: `focus:outline-none transition ease-in duration-200 inline-flex items-center justify-center text-center`,
	...
	color: {
		primary: {
			bg: `text-white bg-blue-700 border border-blue-700 active:ring-2 active:ring-offset-2 active:ring-blue-700 active:ring-offset-blue-200`,
		...
		blue: {
			bg: `text-white bg-blue-600 border border-[#DFDFDF] active:ring-2 active:ring-offset-2 active:ring-indigo-900 active:ring-offset-indigo-200`,
			outline: `text-gray-900 active:border-black border border-[#DFDFDF] active:border active:bg-transparent active:text-black`,
		},
	},
};
	...
	(
		...
		const buttonElement = (
			...
			>
				...
				{children}
				{dropdown?.chevron && <ChevronDownIcon className="w-4 h-4" />}
			</button>
		);

		if (dropdown) {
			const config = { ...DEFAULT_DROPDOWN_CONFIG, ...dropdown };
			return (
				<ButtonDropdown
