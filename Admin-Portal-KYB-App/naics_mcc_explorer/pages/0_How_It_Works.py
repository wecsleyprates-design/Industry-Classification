...
# ═══════════════════════════════════════════════════════════════════════════════
st.info(
    "📐 The interactive decision tree for the full workflow is on the "
    "**🧬 Classification Intelligence** page (first tab in the sidebar). "
    "It shows the complete pipeline from vendor sources through arbitration to the final NAICS and MCC codes.",
    icon="🔀",
)
st.markdown("---")
