			...
			<div className="flex flex-col space-y-1">
				...
				<div className="relative">
					<input
						...
						className={cn(
							"flex h-9 w-full rounded-md border border-input bg-transparent p-2 text-sm text-gray-800 transition-colors file:border-0 file:bg-transparent file:text-sm file:font-medium file:text-foreground placeholder:text-gray-400 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-600 disabled:cursor-not-allowed disabled:opacity-50",
