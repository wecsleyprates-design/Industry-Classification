...
type AdvancedMarkerElement = google.maps.marker.AdvancedMarkerElement | null;
...
> = ({ className, location }) => {
	...
	const [selectedMarker, setSelectedMarker] =
		useState<AdvancedMarkerElement>(null);
	const [zoom, setZoom] = useState(15);
	const apiIsLoaded = useApiIsLoaded();

	const onMarkerClick = useCallback((marker: AdvancedMarkerElement) => {
...
interface AdvancedMarkerWithRefProps {
	onMarkerClick: (marker: AdvancedMarkerElement) => void;
