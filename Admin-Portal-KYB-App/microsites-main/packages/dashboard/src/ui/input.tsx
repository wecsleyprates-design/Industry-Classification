...
const Input = forwardRef<HTMLInputElement, InputProps>(
	({ className, type, label, id, info, error, ...props }, ref) => {
		const inputId = id;
			...
			<div className="flex flex-col space-y-1">
				...
				<div className="relative">
					<input
						...
						className={cn(
							"flex h-9 w-full rounded-md border border-input bg-transparent px-3 py-1 text-sm shadow-sm transition-colors file:border-0 file:bg-transparent file:text-sm file:font-medium file:text-foreground placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-blue-600 disabled:cursor-not-allowed disabled:opacity-50",
