	...
	return (
		<div className="relative flex items-center justify-center">
			...
			{isOpen && (
				<div
					ref={tooltipRef}
					className={`absolute bg-[#9ca3af] text-sm w-[150px] sm:w-[280px] text-white p-2 rounded transition-opacity z-40 ${
						position === "top"
							? "bottom-full mb-2"
							: position === "bottom"
								? "top-full mt-2"
				...
				>
					{tooltip}
					<div
						className={`absolute  bg-[#9ca3af] w-3 h-3 transform rotate-45 ${
							position === "top"
