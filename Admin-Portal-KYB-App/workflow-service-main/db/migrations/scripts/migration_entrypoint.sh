...
DSN="postgres://${CONFIG_DB_USER}:${CONFIG_DB_PASSWORD}@${CONFIG_DB_HOST}/${CONFIG_DB_NAME}?sslmode=require"
DSN_DEFAULT_DB="postgres://${CONFIG_DB_USER}:${CONFIG_DB_PASSWORD}@${CONFIG_DB_HOST}/postgres?sslmode=require"
