...
router
	...
	.all(methodNotAllowed);
// Internal sync endpoint for integration-service (KYB fact overrides -> case business display profile)
router
	.route("/internal/businesses/:businessID/display-profile")
	.patch(
		validateSchema(schema.updateBusinessDisplayProfile),
		validatePurgedBusiness,
		api.updateBusinessDisplayProfile,
	)
	.all(methodNotAllowed);
