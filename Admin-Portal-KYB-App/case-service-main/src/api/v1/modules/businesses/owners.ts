...
export abstract class Owners {
	 ...
	 */
	public static async getExtendedOwnershipLimits(
		fields: { name: string; status: number }[]
	) : Promise<Business.ExtendedOwnerLimits> {
