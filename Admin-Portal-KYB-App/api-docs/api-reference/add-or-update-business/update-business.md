<!-- Source: https://docs.worthai.com/api-reference/add-or-update-business/update-business.md -->
# Update Business
...
> Update an existing business record based on the provided details. One of businessID or external_id MUST be provided to identify a business to update.



## OpenAPI

````yaml patch /businesses/customers/{customerID}
openapi: 3.1.0
info:
  title: Add Business
...
paths:
  /businesses/customers/{customerID}:
    ...
    patch:
      ...
      description: >-
        Update an existing business record based on the provided details. One of
        businessID or external_id MUST be provided to identify a business to
        update.
      ...
      parameters:
        - name: customerID
          in: path
          description: >-
            A unique identifier (UUID) representing the customer instance to
            PATCH into.
          required: true
          style: simple
          schema:
        ...
        - name: businessID
          in: query
          description: A unique identifier (UUID) representing the business to update.
          required: false
          style: form
          schema:
            type: string
        ...
        content:
          application/json:
            ...
            example:
              ...
              official_website: https://abc.com
        required: true
      responses:
        '200':
          description: OK
              ...
              example:
                ...
                data:
                  ...
                  failed_rows:
                    '0':
                      message: >-
                        Error with 1 fields. First error: 'The business external
                        ID already exists for this customer (business ID:
                        9d75fc32-6770-4586-8dd6-9a9a0b6596b2)' --- Please
                        execute /validate first for more details
                      data: {}
                  result: {}
        '401':
          ...
          content:
            application/json; charset=utf-8:
              schema:
                allOf:
                  - fef614d2-326d-472d-ace5-737c576e1c82
                contentMediaType: application/json; charset=utf-8
              example:
                status: fail
